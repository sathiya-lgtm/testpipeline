...
// API Calls
import generateCameraAlertReport from '../../../api_calls/generateCameraAlertReport';
 ...
 */
const CameraAlertReport: FC<IProps> = ({
    activeUser,
    setActiveUser,
    accountType,
    ...
    const [selectedCamera, setSelectedCamera] =
        useState<SingleValue<SelectOption> | null>(allSelectOption[0]);
    const [cameraAlertReportCSV, setCameraConfigReportCSV] = useState('');
    ...
    const cameraReportMutation = useMutation({
        mutationFn: generateCameraAlertReport,
        onError: (err: any) => {
    ...
    const getReport = async (e: FormEvent) => {
        ...
        if (cameraAlertReportCSV) {
            URL.revokeObjectURL(cameraAlertReportCSV);
        }
    ...
    return (
        ...
        >
            <h3 id="title">
                <span>Camera Alert Report Export</span>
            </h3>
            ...
            {cameraAlertReportCSV && (
                <div className="download-container">
                    <hr />
                    <a
                        href={cameraAlertReportCSV}
                        id="camera-alert-report-download"
                        download={`${serviceProviderName}-CameraAlertReport`}
...
export default CameraAlertReport;
